...
def country_scheduler(country_name, resources_file,
  ...
  Schedule.write_csv(best_solution, schedule_evaluator.expected_utility, self_country, "best_solution.csv")
...
def parseCmdLineArgs():
  ...
  parser.add_argument ("-n", "--num-schedules", type=int, default=3, help="The number of output schedules to generate")
